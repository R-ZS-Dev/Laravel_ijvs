...
@section('cssLinks')
    ...
    <link rel="stylesheet" href="{{ asset('asset/css/authorsguide.css') }}">
@endsection

@section('content')
<div class="p-3">
    <h2 class="text-center mt-1">Author’s Guide</h2>
                    ...
                    <div>
                        <div class="accordian mt-2">
                            <input type="checkbox" id="trigger" />
                            <label class='colpsedown' For="trigger">Scope of the Journal</label>
                            <div><strong>
                                International Journal of Veterinary Science (<a href='https://www.ijvets.com/'><span>https://www.ijvets.com/</span></a>) is quarterly (published
                        ...
                        <div class="accordian">
                            ...
                            <label class='colpsedown' For="trigger1">Publishing Ethics</label>
                            <div><strong>
                                ...
                                <a href='https://publicationethics.org/'><span> Committee on Publication Ethics</span></a>.
                        ...
                        <div class="accordian">
                            ...
                            <label class='colpsedown' For="trigger2">Disclaimer by the Editor-in-Chief/Publisher</label>
                            <div><strong>
                        ...
                        <div class="accordian">
                            ...
                            <label class='colpsedown' For="trigger3">Ethical Guidelines for IJVS Publications</label>
                            <div><strong>
                                These guidelines are developed keeping the standards defined by the
                                <a href='https://publicationethics.org/'><span> Committee on Publication Ethics (COPE)</span></a>.
                                ...
                                <a href='https://publicationethics.org/'><span> COPE</span></a>. Any behavior contrary to
                        ...
                        <div class="accordian">
                            ...
                            <label class='colpsedown' For="trigger4">Plagiarism checking</label>
                            <div><strong>
                                ...
                                <a href='https://publicationethics.org/'><span> Committee on Publication Ethics</span></a>. All
                                ...
                                and billions of web contents. Authors can use <a href='http://www.als-journal.com/wp-admin/turnitin.com'><span> Turnitin</span></a> to 
                        ...
                        <div class="accordian">
                            ...
                            <label class='colpsedown' For="trigger5">Editorial Policy/Review Process</label>
                            <div><strong>
                        ...
                        <div class="accordian">
                            ...
                            <label class='colpsedown' For="trigger6">Types of Manuscripts</label>
                            <div><strong>
                        ...
                        <div class="accordian">
                            ...
                            <label class='colpsedown' For="trigger7">Manuscript Preparation and Submission</label>
                            <div><strong>
                                Manuscript completed in all respects be submitted directly to the Editor-in-Chief/Editor
                                <a href='mailto: editor@ijvets.com'><span> (editor@ijvets.com)</span></a> for quick publication processes.
                                ...
                                <label For=''>Abstracts, Keywords, and other headings must start from the next page.</label>
                                <label style= "color: blue" > References Format </label>
                                <label For=''>The IJVS encourages the use of EndNote software (is a commercial reference management
                                ...
                                <label For=''>Citations to the journal’s articles should be cited in the text as: Chugunova (2020) or
                                ...
                                <label For=''>Belizário JE and Sircili MP, 2020. Novel biotechnological approaches for monitoring and
                        ...
                        <div class="accordian">
                            ...
                            <label class='colpsedown' For="trigger8">Bioethics and Animal Use in Research</label>
                            <div><strong>
                                <a href='https://www.ncbi.nlm.nih.gov/books/NBK500418/'><span> Simmonds (2018)</span></a>
                                ...
                                <a href='https://www.ncbi.nlm.nih.gov/books/NBK500418/'><span>  link</span></a>. Furthermore,
                                oversight of animal use in biomedical activities has also been compiled by AAALAC International
                                (<a href='https://www.ncbi.nlm.nih.gov/books/NBK500418/'><span> AAALAC International 2015</span></a>). Implementation
                                ...
                                <label For=''>
                                    ...
                                    laid down in the <a href='https://www.wma.net/what-we-do/medical-ethics/declaration-of-helsinki/'><span> 1964 Declaration of Helsinki</span></a>
                        ...
                        <div class="accordian">
                            ...
                            <label class='colpsedown' For="trigger9">Figures and Tables Format</label>
                            <div><strong>
                        ...
                        <div class="accordian">
                            ...
                            <label class='colpsedown' For="trigger10"> Proofs/Reprints</label>
                            <div><strong>
                                ...
                                <a href='http://www.ijvets.com/archive/'><span>http://www.ijvets.com/archive/</span></a>),
                                thus, can be downloaded without any cost/permission.</strong>
                            </div>
                        </div>
                        <div class="accordian">
                            <input type="checkbox" id="trigger11" />
                            <label class='colpsedown' For="trigger11">Conflict of interest</label>
                            <div><strong>
                                <a href='https://en.wikipedia.org/wiki/Conflicts_of_interest'><span>Conflicts of interest (COIs) </span></a>
                        ...
                        <div class="accordian">
                            ...
                            <label class='colpsedown' For="trigger12">Copyright</label>
                            <div><strong>
                        ...
                        <div class="accordian">
                            ...
                            <label class='colpsedown' For="trigger13">Article Publishing Charges (APCs)</label>
                            <div>
                        ...
                        <div class="accordian">
                            ...
                            <label class='colpsedown' For="trigger14">Waiver/Refund Policy</label>
                            <div><strong>
                                <label For=''>The IJVS administration/publisher are trying to build research abilities/resources for
                        ...
                        <div class="accordian">
                            ...
                            <label class='colpsedown' For="trigger15">Open Access Policy</label>
                            <div><strong>
                                ...
                                <a href='http://creativecommons.org/licenses/by-nc/4.0'><span>http://creativecommons.org/licenses/by-nc/4.0</span></a>). IJVS
                                makes all open access articles freely available on <a href='https://www.ijvets.com/'><span> https://www.ijvets.com/</span></a> from
                        ...
                        <div class="accordian">
                            ...
                            <label class='colpsedown' For="trigger16">Permission Policy</label>
                            <div><strong>
                                ...
                                <strong><label For=''>Libraries in non-educational and commercial institutions or libraries transacting interlibrary 
                                ...
                                <label For=''>You may obtain high quality, bound versions of individual IJVS articles suitable for professional 
                                ...
                                <label For=''>Permission is never granted for use of IJVS for endorsements, implied or otherwise, of 
                        ...
                        <div class="accordian">
                            ...
                            <label class='colpsedown' For="trigger17">Article Withdrawal/Retraction Policy</label>
                            <div><strong>
                    ...
                    <div class='row'>
                        <div class='col-lg-6'>
                            <a href='/asset/uploadfiles/Copyright Release Form.pdf'><span>Author’s Guide</span></a>
                        </div>
                        <div class='col-lg-6'>
                            <a href='/asset/uploadfiles/Copyright.docx'><span>Copyright Release Form</span></a>
                        </div>
                    </div>
</div>
@endsection